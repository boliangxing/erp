...
$canshu[2]=$this->input->post('canshu[2]');
	...
	$r=$this->db->query("INSERT INTO yuanjian (typeid,name,num,bjnum,remark,d0,d1,d2,price1,price2) VALUES ($leibie,'$name','$num','$bjnum','$remark','$canshu[0]','$canshu[1]','$canshu[2]','$price1','$price2')");
